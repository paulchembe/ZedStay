      ...
      GoRoute(
        ...
        builder: (context, state) {
          ...
          return BookingRequestScreen(
            listingId: extra['listingId']?.toString() ?? '',
            hostId: extra['hostId']?.toString() ?? '',
            listingTitle: extra['listingTitle']?.toString() ?? 'Unknown',
            listingCity: extra['listingCity']?.toString() ?? 'Unknown',
            pricePerNight: (extra['pricePerNight'] as num?)?.toDouble() ?? 0.0,
          );
        },
      ),
    ],
